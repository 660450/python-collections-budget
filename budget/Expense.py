...
class Expenses():
    ...
    def categorize_set_comphrehension(self):
        ...
        unnecessary_expenses = set(self.list) - necessary_expense - food_expenses

        return [necessary_expense, food_expenses, unnecessary_expenses]  
